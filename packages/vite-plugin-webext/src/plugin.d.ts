...
export interface WebExtensionOptions {
  ...
  /** Use hashed filenames Default: true */
  useHashedFileName?: boolean;

  /** Sets the use_dynamic_url property on web accessible resources Default: true */
  useDynamicUrl?: boolean;

  /** Enable React HMR for all 'jsx' and 'tsx' modules Default: true */
  useReactHMR?: boolean;
